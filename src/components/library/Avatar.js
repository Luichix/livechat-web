...
const styles = {
  left: StyleSheet.create({
    container: {
      marginRight: 8,
      backgroundColor: 'transparent', // REVIEW this is a hack to get the background color to show up
    },
    onTop: {
    ...
    if (props.currentMessage) {
      return (
        <GiftedAvatar
          ...
          onPress={() => {
            var _a
            return (_a = props.onPressAvatar) === null || _a === void 0
              ? void 0
              : _a.call(props, props.currentMessage.user)
          }}
          onLongPress={() => {
            var _a
            return (_a = props.onLongPressAvatar) === null || _a === void 0
              ? void 0
              : _a.call(props, props.currentMessage.user)
          }}
        />
